...
cp -rpf $patch/init.qcom.mem.sh /system/etc/init.qcom.mem.sh
chmod -R 644 /system/etc/init.qcom.mem.sh
...
replace_line init.qcom.power.rc "write /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq" "    write /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq 302400";
