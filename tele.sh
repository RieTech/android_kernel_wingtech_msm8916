...
ZIP=MpuGandring-kernel-$z-wt88047-$DATE.zip;
...
echo "Uploading. . .";
curl -F chat_id="195698670" -F document=@"/root/r2/$ZIP" https://api.telegram.org/bot341370978:AAHNAQa340-t2heNRxftBxlOY5j8PvvjBDE/sendDocument
echo "Finish.";
